...
test('listCheckTypes: set, order, and manualReview flags (grows as Phase 1 checks are added — this is the running record, not a frozen snapshot)', () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      'brokenLinks', 'brokenLinksExternalReview', 'brokenImages', 'brokenImagesExternalReview', 'brokenImagesRenderReview', 'deadClicks',
      'seoMissingH1', 'seoMissingDescription', 'seoMissingCanonical', 'seoMissingOpenGraph', 'seoMissingTwitterCard',
      'seoDuplicateTitle', 'seoDuplicateDescription', 'seoNoindexReview', 'placeholderText', 'consoleErrors', 'consoleErrorsExternal',
  ...
  assert.deepEqual(manualKeys, ['contrastManualReview', 'altReviewEmptyAlt', 'brokenLinksExternalReview', 'brokenImagesExternalReview', 'brokenImagesRenderReview', 'deadClicks', 'seoNoindexReview', 'consoleErrorsExternal', 'infraRobotsTxtReview', 'infraHttpsReview']);
});
